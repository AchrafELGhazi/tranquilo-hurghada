...
import { sendWelcomeEmailHandler, sendNewBookingNotificationHandler, sendBookingConfirmationHandler, sendBookingRejectionHandler, sendBookingCancellationHandler } from '../controllers/email.controller';
